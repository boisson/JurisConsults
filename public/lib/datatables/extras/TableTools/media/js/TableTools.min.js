...
TableTools.prototype = {
  ...
  "_fnConstruct": function ( oOpts )
  {
    ...
    this.dom.container.className = !this.s.dt.bJUI ? "btn-group btn-group-not-clear" :
      "btn-group btn-group-not-clear ui-buttonset ui-buttonset-multi";
  ...
  "_fnCustomiseSettings": function ( oOpts )
  {
    ...
    if(crud_datatable.data('permissions') != undefined){
      var allowed_actions = crud_datatable.data('permissions').split(',')
  ...
  "_fnButtonBase": function ( o )
  {
    ...
    nButton.className = "btn "+o.sButtonClass;
  ...
  "_fnCollectionShow": function ( nButton, oConfig )
  {
     ...
     */
    // setTimeout( function () {
      $(nHidden).animate({"opacity": 1}, 100);
      $(nBackground).animate({"opacity": 0.25}, 100);
    // }, 10 );
  ...
  /**
   * Show a button collection of menu drop down
   *  @param   {Node} nButton Button to use for the collection
   *  @param   {Object} oConfig Button configuration object
   *  @returns void
   *  @private
   */
  "_fnCollectionMenuDropDownShow": function ( nButton, oConfig )
  {
    $(nButton).append('ola')
    console.log(oConfig)
    var
  ...
  "_fnFlashConfig": function ( nButton, oConfig )
  {
    ...
    $(nButton).attr('title',oConfig.sToolTip)
...
TableTools.BUTTONS = {
  ...
  "text": {
    "sAction": "text",
    "sToolTip": "",
    "sButtonClass": "DTTT_button_text ttip_b",
    "sButtonClassHover": "DTTT_button_text_hover ttip_b",
  ...
  "collectionMenuDropDown": {
    "sAction": "collection",
    "sToolTip": "",
    "sButtonClass": "btn DTTT_button_text dropdown-toggle",
    "sButtonClassHover": "btn  dropdown-toggle",
    "sButtonText": "Collection",
    "fnMouseover": null,
    "fnMouseout": null,
    "fnClick": function( nButton, oConfig ) {
      this._fnCollectionMenuDropDownShow(nButton, oConfig);
    },
    "fnSelect": null,
    "fnComplete": null,
    "fnInit": null,
