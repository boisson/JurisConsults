  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contrato as @contrato" do
        ...
        post :create, {:contrato => { "name" => "invalid value" }}, valid_session
        assigns(:contrato).should be_a_new(Contrato)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contrato" do
        ...
        Contrato.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => contrato.to_param, :contrato => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contrato as @contrato" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contrato.any_instance.stub(:save).and_return(false)
        put :update, {:id => contrato.to_param, :contrato => { "name" => "invalid value" }}, valid_session
        assigns(:contrato).should eq(contrato)
      end
