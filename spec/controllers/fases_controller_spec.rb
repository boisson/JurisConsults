...
describe FasesController do
  ...
  describe "GET new" do
    it "assigns a new fase as @fase" do
      ...
      assigns(:fase).should be_a_new(Fase)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created fase as @fase" do
        post :create, {:fase => valid_attributes}, valid_session
        assigns(:fase).should be_a(Fase)
        assigns(:fase).should be_persisted
      end

      it "redirects to the created fase" do
        post :create, {:fase => valid_attributes}, valid_session
        response.should redirect_to(Fase.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved fase as @fase" do
        ...
        Fase.any_instance.stub(:save).and_return(false)
        post :create, {:fase => { "name" => "invalid value" }}, valid_session
        assigns(:fase).should be_a_new(Fase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested fase" do
        fase = Fase.create! valid_attributes
        # Assuming there are no other fases in the database, this
        # specifies that the Fase created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Fase.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => fase.to_param, :fase => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the fase" do
        fase = Fase.create! valid_attributes
        put :update, {:id => fase.to_param, :fase => valid_attributes}, valid_session
        response.should redirect_to(fase)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the fase as @fase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Fase.any_instance.stub(:save).and_return(false)
        put :update, {:id => fase.to_param, :fase => { "name" => "invalid value" }}, valid_session
        assigns(:fase).should eq(fase)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the fases list" do
      fase = Fase.create! valid_attributes
      delete :destroy, {:id => fase.to_param}, valid_session
      response.should redirect_to(fases_url)
    end
  end
