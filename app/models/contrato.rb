class Contrato < ActiveRecord::Base
  ...
  has_paper_trail class_name: 'ContratoVersion'
	...
	UNRANSACKABLE_ATTRIBUTES = %w[processo_id processo forma_pagamento_id forma_pagamento dt_inicio dt_fim dt_assinatura advogado_id advogado tipo_processo_id tipo_processo]
